...
# versions
GCC_VER_MIN_71 := $(shell echo `$(CXX) -dumpfullversion |cut -f1-2 -d.` \>= 7.1 |bc)
GCC_VER_MIN_61 := $(shell echo `$(CXX) -dumpfullversion |cut -f1-2 -d.` \>= 6.1 |bc)
GCC_VER_MIN_51 := $(shell echo `$(CXX) -dumpfullversion |cut -f1-2 -d.` \>= 5.1 |bc)
