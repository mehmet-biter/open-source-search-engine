...
public:
	...
	bool initialize(unsigned num_coordinator_threads, unsigned num_cpu_threads, unsigned num_io_threads, unsigned num_external_threads, job_done_notify_t job_done_notify=0);
	void finalize();
