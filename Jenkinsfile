	...
	stages {
		...
		stage('Build') {
			steps {
				...
				archiveArtifacts artifacts: "${env.GB_PROJECT}/*.tar.gz,${env.GB_PROJECT}/libgb.a,${env.GB_PROJECT}/**/*.h,gbclean.sh", excludes: "${env.GB_PROJECT}/test/**,${env.GB_PROJECT}/third-party/**", fingerprint: true
			}
		}
